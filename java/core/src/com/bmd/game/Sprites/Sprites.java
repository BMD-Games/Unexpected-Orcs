...
public class Sprites {
    public static HashMap<Integer, Sprite> tileSprites;
    public static HashMap<String, Sprite> itemSprites;
    public static HashMap<String, Sprite> guiSprites;
    public static HashMap<String, Sprite> charSprites;
    public static HashMap<String, Sprite> projectileSprites;
    public static HashMap<String, Sprite> dropSprites;
    public static HashMap<String, Sprite> statusSprites;
    public static HashMap<String, Sprite> playerStatusSprites;

    public final static int SPRITE_SIZE = 16;

    public static void loadAssests() {
        tileSprites = new HashMap<Integer, Sprite>();
        itemSprites = new HashMap<String, Sprite>();
        guiSprites = new HashMap<String, Sprite>();
        charSprites = new HashMap<String, Sprite>();
        projectileSprites = new HashMap<String, Sprite>();
        dropSprites = new HashMap<String, Sprite>();
        statusSprites = new HashMap<String, Sprite>();
        playerStatusSprites = new HashMap<String, Sprite>();


        //-----TILE SPRITES-----
        Texture tilesheet = new Texture("./sprites/tilesheet.png");
        ...
        //-----ITEM SPRITES-----
        Texture itemsheet = new Texture("./sprites/itemsheet.png");
        int itemSize = 16;
        ...
        Texture statusSheet = new Texture("./sprites/statussheet.png");
        int statusSize = 8;
        ...
        Texture playerStatusSheet = new Texture("./sprites/playerstatussheet.png");
        ...
        //-----DROP SPRITES-----
        Texture dropsheet = new Texture("./sprites/dropsheet.png");
        int dropSize = 8;
        ...
        //-----GUI SPRITES----
        Texture sheet = new Texture("./sprites/spritesheet.png");
        int guiSize = 16;
        ...
        //-----CHAR SPRITES-----
        Texture charsheet = new Texture("./sprites/charsheet.png");
        int charSize = 8;
        ...
        //-----BULLET SPRITES-----
        Texture projectilesheet = new Texture("./sprites/projectilesheet.png");
        ...
        Pixmap cursor = new Pixmap(Gdx.files.internal("./sprites/cursor.png"));
        Gdx.graphics.setCursor(Gdx.graphics.newCursor(cursor, 0, 0));
        cursor.dispose();
    }


    public static Sprite tileSprite(int name, int w, int h) {
        Sprite tile = new Sprite(tileSprites.get(name));
        tile.setSize(w, h);
        return tile;
    }

    public static Sprite itemSprite(String name, int w, int h) {
        Sprite tile = new Sprite(itemSprites.get(name));
        tile.setSize(w, h);
        return tile;
    }

    public static Sprite statusSprite(String name, int w, int h) {
        Sprite tile = new Sprite(statusSprites.get(name));
        tile.setSize(w, h);
        return tile;
    }

    public static Sprite playerStatusSprite(String name, int w, int h) {
        Sprite tile = new Sprite(playerStatusSprites.get(name));
        tile.setSize(w, h);
        return tile;
    }

    public static Sprite dropSprite(String name, int w, int h) {
        Sprite tile = new Sprite(dropSprites.get(name));
        tile.setSize(w, h);
        return tile;
    }

    public static Sprite guiSprite(String name, int w, int h) {
        Sprite tile = new Sprite(guiSprites.get(name));
        tile.setSize(w, h);
        return tile;
    }

    public static Sprite charSprite(String name, int w, int h) {
        Sprite tile = new Sprite(charSprites.get(name));
        tile.setSize(w, h);
        return tile;
    }

    public static Sprite projectileSprite(String name, int w, int h) {
        Sprite tile = new Sprite(projectileSprites.get(name));
        tile.setSize(w, h);
        return tile;
    }

    public static Sprite getSprite(Texture spriteSheet, int x, int y, int w, int h, int spriteSize) {
        return new Sprite(spriteSheet, x * spriteSize, y * spriteSize, w * spriteSize, h * spriteSize);
    }
